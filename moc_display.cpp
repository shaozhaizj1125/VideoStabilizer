...
QT_MOC_LITERAL(1, 8, 13), // "itemProcessed"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 15), // "onItemProcessed"
QT_MOC_LITERAL(4, 39, 9) // "item_path"

    },
    "Display\0itemProcessed\0\0onItemProcessed\0"
    "item_path"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemProcessed((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->onItemProcessed((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Display::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::itemProcessed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Display::itemProcessed(const QString & _t1)
{
